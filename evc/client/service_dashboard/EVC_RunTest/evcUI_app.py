...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            sample3 = gr.Video(value="./sample_imgs/fashion_sample.mp4", autoplay=True)  
            hardhat_btn = gr.Button("Deploy")

        with gr.Column():
            markdown = gr.Markdown("# <strong> Wind Mills Detection Service </strong>")
            sample4 = gr.Video(value="./sample_imgs/fashion_sample.mp4", autoplay=True)  
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            sample5 = gr.Video(value="./sample_imgs/fashion_sample.mp4", autoplay=True)  
            tomato_btn = gr.Button("Deploy")

        with gr.Column():
            markdown = gr.Markdown("# <strong> License Plate Detection Service </strong>")
            sample6 = gr.Video(value="./sample_imgs/fashion_sample.mp4", autoplay=True)  
