    ...
    def verify(self):
        ...
        if model in search.text:
            ...
            if task in search2.text:
                ...
                result = """we already have the model.

                download command : 'docker pull {url}/{image_name}'
                """.format(url=reg_url, image_name=image_name)
                print(result)

                
            else:
                result = 'activate distribution sequence.'
                print(result)
