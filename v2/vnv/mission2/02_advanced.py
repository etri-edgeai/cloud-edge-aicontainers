...
cmd = 'ansible vnv -i hosts.ini -m shell -a "cd /home/jpark/WorkDevEdgeAI/cloud-edge-aicontainers/v2/vnv/mission2; pwd; /usr/bin/python3 vnv03.py resnet101 cuda 0;"  > ./tmp/baseline.txt  ' 
run(cmd, False)
